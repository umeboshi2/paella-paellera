...
from paellera.views.base import AdminViewer, make_main_menu
from paellera.managers.wiki import WikiArchiver
...
class SiteTextViewer(AdminViewer):
    ...
    def list_site_text(self):
        self._set_menu()
        template = 'paellera:templates/list-site-text.mako'
